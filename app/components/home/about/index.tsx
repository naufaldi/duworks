...
const About = () => {
  return (
    <Box as='section' id="about" w="full">
      ...
      >
        <Grid templateColumns={{ base: 'repeat(6m1fr)', sm: "repeat(12,1fr)" }} columnGap="16px">
          ...
          <GridItem position="relative" colSpan={{ base: 6, sm: 11 }} colEnd={{ base: 7, sm: 13 }} h={{ base: '200px', sm: '300px', lg: '475px' }}>
            <CurveRed
              position="absolute"
              top="-8px"
